...
TABLE_SCHEMAS = {
    ...
    "metricas_derivadas": [
        "cod_prov", "provincia", "poblacion", "total_viajeros",
        "media_mensual_viajeros", "std_mensual_viajeros",
        "presion_turistica", "indice_estacionalidad", "n_meses", "_meta.fecha_extraccion"
    ],
    "Carto_provincias": [
